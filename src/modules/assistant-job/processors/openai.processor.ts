...
export const OpenaiO3MiniProcessor: new (...args: any[]) => ProcessorFactory =
  createProcessor(LLM_MODEL.GPT_O3_MINI, AssistantBaseProcessor);

export const OpenaiO1Processor: new (...args: any[]) => ProcessorFactory =
  createProcessor(LLM_MODEL.GPT_O1, AssistantBaseProcessor);
