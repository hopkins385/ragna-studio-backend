...
interface IFluxKontextProInputsDto {
  prompt: string;
...
export class FluxKontextProInputsDto {
  ...
  constructor(input: IFluxKontextProInputsDto) {
  ...
  static fromInput(input: IFluxKontextProInputsDto): FluxKontextProInputsDto {
    return new FluxKontextProInputsDto(input);
  }
}
...
export class FluxKontextProBody extends createZodDto(bodySchema) {}
